...
cache_files = dict(
    ...
    coco='data/cache/cliff_coco_train_smpl_49.npz',
    #lspet='data/cache/eft_lspet_train_smpl_49.npz',
    pw3d='data/cache/pw3d_train_smpl_49.npz',
    mpii='data/cache/cliff_mpii_train_smpl_49.npz',
...
data = dict(
    ...
    train=dict(
        ...
        train_dataset=dict(
            ...
            partition=[0.4, 0.25, 0.05, 0.15, 0.15],
        ),
        adv_dataset=dict(
            type='MeshDataset',
